...
public class RequestMappingMethodInvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (getMapping != null) {
            ...
            StringBuilder uriBuilder = new StringBuilder("http://").append(serviceName).append("/").append(uri[0]);
            // 获取方法参数数量
            ...
            for (int i = 0; i < count; i++) {
                ...
                RequestParam requestParam = (RequestParam) paramAnnotations[0];//拿到参数的第一个注解
                if (requestParam != null) {
                    ...
                    queryStringbuiler.append("&").append(requestParamName).append("=").append(requestParamValue);
                }
            }

            String queryString = queryStringbuiler.toString();
